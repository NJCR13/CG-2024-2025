...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/barroselas.vert", "shaders/barroselas.frag"),
		...
		this.testShaders[9].setUniformsValues({ normScale: 1 })
		this.testShaders[9].setUniformsValues({ timeFactor: 0 })
		this.testShaders[10].setUniformsValues({ normScale: 1 })
