...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene, 'quadDisplay').name('Display Quad');
        this.gui.add(this.scene, 'quadMaterialDisplay').name('Display Quad Mat');
        this.gui.add(this.scene, 'tangramDisplay').name('Display Tangram');
        this.gui.add(this.scene, 'unitCubeDisplay').name('Display UnitCube');
