...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.textureLados = new CGFtexture(this, 'images/mineSide.png');
        this.UnitCubeQuad = new MyUnitCubeQuad(this, this.textureCima, this.textureLados, this.textureLados, this.textureLados, this.textureLados, this.textureBaixo);
        ...
        this.wrapS = 0;
        this.wrapT = 0;
        this.quadDisplay = false;
        this.tangramDisplay = false;
        this.unitCubeDisplay = true;
        this.quadMaterialDisplay = false;


        this.textures = [this.texture1, this.texture2, this.texture3, this.texture];
    ...
    display() {
        ...
        if(this.quadMaterialDisplay) this.quadMaterial.apply();
        ...
        if(this.quadDisplay) this.quad.display();
        if(this.tangramDisplay) this.tangram.display(); 
        if(this.unitCubeDisplay) this.UnitCubeQuad.display();
